 ...
 * prints: the design, the signer and the campus. Split out so a batch of
...
function card_fingerprint(array $u): string
{
    ...
    if ($shared === null) {
        $card   = id_card_settings();
        $shared = array_intersect_key(id_card_shared_context(null), array_flip(['chief', 'chief_title']))
    ...
    foreach (array_merge(
        ...
        $student ? ['year_level', 'symbol_no', 'national_id', 'pan_no']
