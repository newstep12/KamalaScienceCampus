...
function send_notification(string $to, string $subject, string $body): bool
{
    ...
    $fromName = (string) setting('mail_from_name', 'Shree Kamala Secondary School');
...
function notify_student_approved(array $student): void
{
    $body = "Dear {$student['full_name']},\n\n"
        . "Your Shree Kamala Secondary School +2 Science portal account has been approved. "
...
{
    $body = "Dear {$student['full_name']},\n\n"
        . "Your Shree Kamala Secondary School +2 Science portal registration was not approved.\n"
        . ($note ? "\nReason: {$note}\n" : '')
